...
exports.product_collection_enums = ["used", "new", "luxury"];
exports.product_status_enums = ["AVAILEBLE", "PROCESS", "SOLD"];
exports.product_size_enums = ["sedan", "hatchback", "offroad", "crossover", "cabrio", "sport", "eco"];
